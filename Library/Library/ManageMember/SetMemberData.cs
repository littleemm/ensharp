...
namespace Library
{
    class SetMemberData
    {
        ...
        {
            memberList.Add(new MemberVO("gogogo1", "password1", "고양이", "20210101", "경기도 고양시", "01011111111", ""));
            ...
            memberList.Add(new MemberVO("iimmmmm", "password5", "어피치", "20000303", "경기도 성남시", "01055555555", ""));
